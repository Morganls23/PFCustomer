...
const redirectUri = baseUrl + 'PFCustomer/index-finance.html'; // whitelisted url P14C sends the token or code to

const clientId = 'BeFinance';
const authUrl = 'https://morg360.ping-eng.com:9031';
const apiUrl = 'https://morg360.ping-eng.com:443';

const userAuthScopes = 'openid';
...
const adminRedirectUri =baseUrl + 'PFCustomer/content/finance/admin-login.html';
...
const authorizationUrl =
  ...
  const adminAuthorizationUrl =
    ...
    responseType +
    '&redirect_uri=' +
    "https://morganapps.ping-eng.com/PFCustomer/content/finance/register.html" +
    '&scope=' +
    scopes;
...
function redirect_toReg(){
  location.href = 'https://morganapps.ping-eng.com/PFCustomer/content/finance/register.html?' + 'environmentId=' + environmentId + '&flowId=' + flowId;
}
